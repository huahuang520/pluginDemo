...
{
public:
    virtual void NotifyMotion3DStateChanged(MLMotionState old_state, MLMotionState new_state) = 0;
...
public:
    ...
    virtual void Subscribe(MLMotionEvent event, MLMotion3DCallback* callback) = 0;

    virtual void Unsubscribe(MLMotionEvent event, MLMotion3DCallback* callback) = 0;
