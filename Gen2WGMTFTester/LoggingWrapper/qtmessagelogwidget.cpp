    ...
    d_ptr( new QtMessageLogWidgetPrivate( this ) )
{
    ...
    setStyleSheet("QWidget{background:#F8FFFF;}"); //set background color
}
...
void LogWidget::CreateToolBar()
{
    ...
    widget->setStyleSheet(".QWidget{background-color:rgba(243,248,248); }");
    ...
    QAction * clear = new QAction(QIcon(":/Gen2WGMTFTester/images/routine/clear.jpg"), "&clear log", this);
    changeLogHeight = new QSlider(Qt::Horizontal, this);
    changeLogHeight->setMaximumWidth(50);
    changeLogHeight->setMinimum(100);
    changeLogHeight->setMaximum(250);
    ...
    //m_qVBoxLayout->addItem(qHBoxLayout);
